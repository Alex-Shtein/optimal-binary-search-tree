...
#include "../Task3/OptimalBinarySearchTree.h"
...
TEST(OBST, Test1)
{
    ...
    OptimalBinarySearchTree<int> tree(arr, success, failure, 4);
...
TEST(OBST, Test3)
{
    ...
    int success[] = {0, 1, 1, 1};
    int failure[] = {0, 0, 0, 0};
    OptimalBinarySearchTree<int> tree(arr, success, failure, 3);
    auto result = tree.RoundRootLR();
...
TEST(OBST, Test4)
{
    ...
    OptimalBinarySearchTree<int> tree(arr, success, failure, 7);
    auto result = tree.RoundRootLR();
